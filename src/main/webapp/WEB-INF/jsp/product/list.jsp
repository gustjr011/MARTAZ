			...
			<div class="d-flex fd_col">
				...
				<main class="content">
					<div class="container-fluid p-0">
						<div class="row mb-3">
							<h1 class="col-md-12 h3">상품 목록</h1>
						</div>
						<div class="row">
							<div class="col-12">
								<div class="card">
													...
													<tr>
														...
														<td>
															<div class="form-group mb-0">
																...
																<select id="platformType_${rs.productNo}" class="form-control">
																	<option value="0" selected>추가 선택해 주세요</option>
														...
														<td class="text-nowrap">
															<c:forEach var="detail" items="${rs.detailList}"  varStatus="status">
																...
																<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#sizedModalLg" onclick="javascript:keywordlist(${detail.D_DetailNo})">키워드 관리</button>
																<br>
															</c:forEach>
															<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#sizedModalLg" onclick="javascript:detailSave(${rs.productNo}, 0)">추가 정보 저장</button>
														</td>
													</tr>
												</c:forEach>
													<tr>
